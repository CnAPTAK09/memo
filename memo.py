...
q2 = Question("дім", "da", "house", "home", "net")
q3 = Question("що таке poco x3 pro?", "ядерна бомба", "телефон", "ігровий телефон", "план по захвату")
q4 = Question("7*8", "15", "67", "56", "12")
